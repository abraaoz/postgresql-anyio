...
from postgresql_anyio import Codec, _codecs
...
def test_json():
  _test_codec(_codecs.Json, [{}, [], {"foo": 100.5}, [{}, [{}], {"a": [1]}]])


def test_jsonb():
  _test_codec(_codecs.Jsonb, [{}, [], {"foo": 100.5}, [{}, [{}], {"a": [1]}]])
...
def test_inet():
  _test_codec(_codecs.Inet, [ip_address("192.168.1.1"), ip_address("::3")])
...
def test_cidr():
  _test_codec(_codecs.Cidr, [ip_network("192.168.0.0/16"), ip_network("::/8")])
...
def test_datetime():
  _test_codec(_codecs.DateTime, [datetime(2022, 4, 18, 1, 31, 43, 646120)])
